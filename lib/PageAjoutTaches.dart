...
class PageAjoutTaches extends StatefulWidget {
  @override
  _PageAjoutTachesState createState() => _PageAjoutTachesState();
}

class _PageAjoutTachesState extends State<PageAjoutTaches> {
  final TextEditingController _titleController = TextEditingController();
  final TextEditingController _contentController = TextEditingController();
  DateTime _selectedDate = DateTime.now();
  String _selectedPriority = 'basse';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Ajouter Tache',style: TextStyle(color: Colors.black),),
